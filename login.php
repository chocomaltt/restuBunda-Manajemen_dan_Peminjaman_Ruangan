...
<body>
    <section class="container-fluid text-center" style="height: 100vh;">
        <div class="row" style="height: 100%">
            <div class="col d-flex justify-content-center align-items-center"
                style="width:100%; height:100vh; background-color: #10375C; opacity: 1; background-image: url(assets/img/gedung_sipil_login.png);  background-size:100% 100%;">
            ...
            <div class="col bg-biru d-flex flex-column justify-content-center align-items-center">
                <form id="loginForm" action="cek_login.php"
                    class="d-flex flex-column gap-3 w-75 px-3 py-5 bg-white rounded-4" method="post"
                    onsubmit="return validateForm()">
                    <div class="w-100 justify-content-center">
                        <img src="assets/img/logo_jti_baru.png" style="width: 13%;" class="justify-content-center"
                            alt="">
                    </div>
                    <h1 class="h3 mb-5 fw-bolder">Peminjaman Ruangan</h1>
                    <div class="form-floating">
                        <input type="text" class="form-control form-default shadow bg-body-tetiary-rounded"
                            id="floatingInput" placeholder="Username" name="username" required>
                        <label for="floatingInput" class="label-hitam">Username</label>
                    </div>
                    <div class="form-floating">
                        <input type="password" class="form-control form-default shadow bg-body-tetiary-rounded"
                    ...
                    <div class="d-flex justify-content-between">
                        <div class="form-check text-start mt-2 ">
                            <input type="checkbox" class="form-check-input border border-black" value="remember-me"
                                id="flexCheckDefault">
    ...
    <script>
        function validateForm() {
            // Mengambil nilai captcha response
            var captchaResponse = grecaptcha.getResponse();

            // Memeriksa apakah captcha telah diisi
            if (captchaResponse.length == 0) {
                // Jika captcha kosong, tampilkan pesan kesalahan dan batalkan pengiriman formulir
                alert("Harap isi captcha sebelum melanjutkan.");
                return false;
            }
