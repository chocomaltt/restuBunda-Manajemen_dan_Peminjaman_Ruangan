    ...
    <div class="w-100 vh-100 position-relative" style="z-index: 0; margin-top: 59px; padding: 0 30px;">
        ...
        <div class="d-flex flex-column align-items-center">
            ...
            foreach ($query as $row) {
                ?>
                <form action="index.php?page=controller/pinjam-ruang.php" method="post" class="bg-biru p-4 w-75 d-flex flex-column gap-3">
                    <input type="hidden" class="form-control rounded bg-white" id="PeminjamanID" name="data[]">
                    <input type="hidden" class="form-control rounded bg-white" id="AkunID" name="data[]" value="<?=$_SESSION['idUser'];?>">
                    <div>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" class="form-control rounded bg-white" id="WaktuPinjam" name="data[]"
                        required>
                    </div>
                    <div>
                        <label class="fw-bold text-white" for="tglReturn">Tanggal dan Waktu Pengembalian :</label>
                        <input type="datetime-local" class="form-control rounded bg-white" id="WaktuKembali" name="data[]"
                        required>
                    </div>
                    <div>
                    ...
                    <div class="w-100 d-flex justify-content-center">
                        ...
                        <input type="hidden" class="form-control rounded bg-white" id="StatusPeminjaman" name="data[]" value="Menunggu Konfirmasi">
