    ...
    <div class="table-responsive">
        ...
        <table class="table" style="table-layout: auto;">
            ...
            <tbody>
                ...
                $query = readData($koneksi, "peminjaman", '', $joinConditions, 'peminjaman.StatusPeminjaman = "Dibatalkan" OR peminjaman.StatusPengembalian = "Menunggu Konfirmasi"');
                if (!empty($query)) {
            ...
            <div class="modal fade" id="editModal<?= $row['PeminjamanID']; ?>" tabindex="-1" data-bs-backdrop="static"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="index.php?page=controller/pengembalian.php&aksi=ubah" method="post">
                            <div class="modal-body">
                                ...
                                <?php
                                if ($row['StatusPeminjaman'] == "Dibatalkan") {
                                    ?>
                                    <div class="mb-3">
                                        <label for="id" class="col-form-label">Status :</label>
                                        <input type="text" name="data[]" class="form-control" id="id"
                                            value="<?= $row['StatusPeminjaman']; ?>" readonly>
                                    </div>
                                <?php } ?>
                                <div class="mb-3">
                                    <label for="id" class="col-form-label">Catatan Pengembalian :</label>
                                    <input type="text" name="CatatanPengembalian" class="form-control" id="id"
                                        value="<?= $row['CatatanPengembalian']; ?>">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <a href="index.php?page=controller/pengembalian.php&aksi=setujui&id<?= $row['PeminjamanID']; ?>"
                                    role="button" class="btn btn-warning">Disetujui</a>
                            </div>
                        </form>
                    </div>
                </div>
