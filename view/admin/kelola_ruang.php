            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            Edit</a> -->
                                <a role="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModal" data-bs-whatever="@mdo">Edit</a>
        ...
        <div class="modal-content">
            ...
            <form action="../../function/tambah.php?user=tambah" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-warning" data-bs-dismiss="modal" aria-hidden="true"><i class="bi bi-x-lg"></i>Simpan</button>
                    <button type="submit" class="btn btn-secondary" aria-hidden="true"><i class="bi bi-floppy"></i>Batal</button>
                </div>
            </form>
        </div>
    </div>
