...
<main>
    ...
    <div class="content" style="display: flex; gap: 8px; flex-direction: column;">
        ...
        <div class="denahruang" style="display: flex; flex-wrap: wrap; gap: 40px; width: 100%;">
            ...
            ?>
            <div class="denah">
                <img src="view/admin/img/<?= $row['File']; ?>" alt=""
                    style="width: 540px; height: 363px; border-radius: 20px;">
                <div class="lt">
                    Denah Ruang Lantai <?= $row['DeskripsiLantai']; ?>
                    <a role="button" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#editModalDenah<?= $row['DenahID']; ?>"
...
<?php
    ...
    if(!empty($query)) {
        foreach ($query as $row){
?>
<div class="modal fade" id="editModalDenah<?= $row['DenahID']; ?>" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
            ...
            <form action="index.php?page=controller/denah_admin.php&aksi=ubah" method="post">
                ...
                <input type="text" name="data[]" class="form-control" id="id" value="<?= $row['DeskripsiLantai']; ?>">
                    <div class="mb-3">
                        ...
                        <input type="file" name="data[]" class="form-control" id="id"
                            accept=".png, .jpg, .jpeg, .svg, .heic" value="<?= $row['File']; ?>">
                    </div>
                    <div class="mb-3">
