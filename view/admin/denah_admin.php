                    ...
                    <div class="denah">
                        ...
                        <div class="lt">
                            ...
                            <a role="button" class="btn btn-warning" data-bs-toggle="modal"
                                data-bs-target="#editModalDenah<?= $row['DenahID']; ?>" data-bs-whatever="@mdo">Detail</a>
                        </div>
                    </div>
                <?php }
            } ?>
...
if (!empty($query)) {
    foreach ($query as $row) {
        ?>
        <div class="modal fade" id="editModalDenah<?= $row['DenahID']; ?>" tabindex="-1" data-bs-backdrop="static"
                    ...
                    <form action="index.php?page=controller/denah_admin.php&aksi=ubah" method="post" enctype="multipart/form-data">>
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" name="file" class="form-control" id="id"
